...
export const SdkMcpServerConfigSchema = z.object({
    ...
    instance: z.custom((val) => val &&
        typeof val === 'object' &&
        'connect' in val &&
        typeof val.connect === 'function', { message: 'instance must be an MCP Server with connect method' }),
});
/**
...
export const QueryOptionsSchema = z
    ...
    stderr: z
        .custom((val) => typeof val === 'function', { message: 'stderr must be a function' })
        .optional(),
    ...
    .strict();
//# sourceMappingURL=queryOptionsSchema.js.map