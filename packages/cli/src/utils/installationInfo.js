...
export function getInstallationInfo(projectRoot, isAutoUpdateDisabled) {
    ...
    try {
        ...
        if (realPath.includes('/.pnpm/global')) {
            const updateCommand = 'pnpm add -g @opengame/opengame@latest';
            return {
        ...
        if (realPath.includes('/.yarn/global')) {
            const updateCommand = 'yarn global add @opengame/opengame@latest';
            return {
        ...
        if (realPath.includes('/.bun/bin')) {
            const updateCommand = 'bun add -g @opengame/opengame@latest';
            return {
        ...
        // Assume global npm
        const updateCommand = 'npm install -g @opengame/opengame@latest';
        return {
