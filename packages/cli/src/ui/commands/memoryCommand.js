 ...
 */
import { getErrorMessage, loadServerHierarchicalMemory, QWEN_DIR, } from '@opengame/opengame-core';
...
export const memoryCommand = {
    ...
    subCommands: [
        ...
        },
        {
            name: 'add',
            get description() {
                return t('Add content to the memory. Use --global for global memory or --project for project memory.');
            },
            kind: CommandKind.BUILT_IN,
            action: (context, args) => {
                if (!args || args.trim() === '') {
