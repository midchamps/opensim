...
import { query, isSDKAssistantMessage, isSDKSystemMessage, isSDKResultMessage, isSDKPartialAssistantMessage, } from '@opengame/sdk';
import { SDKTestHelper, extractText, createSharedTestOptions, assertSuccessfulCompletion, collectMessagesByType, } from './test-helper.js';
    ...
    describe('Simple Text Queries', () => {
        ...
        it('should handle greeting and self-description', async () => {
            ...
            try {
                ...
                const assistantMessages = collectMessagesByType(messages, isSDKAssistantMessage);
    ...
    describe('System Initialization', () => {
        it('should receive system message with initialization info', async () => {
            ...
            try {
                ...
                const systemMessageIndex = messages.findIndex((msg) => isSDKSystemMessage(msg) && msg.subtype === 'init');
    ...
    describe('Message Type Recognition', () => {
        it('should correctly identify all message types', async () => {
            ...
            try {
                ...
                const assistantMessages = collectMessagesByType(messages, isSDKAssistantMessage);
                const resultMessages = collectMessagesByType(messages, isSDKResultMessage);
                const systemMessages = collectMessagesByType(messages, isSDKSystemMessage);
                expect(assistantMessages.length).toBeGreaterThan(0);
    ...
    describe('Error Handling', () => {
        it('should throw if CLI not found', async () => {
            try {
                ...
                expect(error.message).toContain('Invalid pathToQwenExecutable');
            }
        });
    });
...
//# sourceMappingURL=single-turn.test.js.map