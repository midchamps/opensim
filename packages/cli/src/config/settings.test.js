...
getSystemSettingsPath, getSystemDefaultsPath, SETTINGS_DIRECTORY_NAME, // This is from the original module, but used by the mock.
migrateSettingsToV1, needsMigration, loadEnvironment, migrateDeprecatedSettings, SettingScope, SETTINGS_VERSION, SETTINGS_VERSION_KEY, } from './settings.js';
...
describe('Settings Loading and Merging', () => {
    ...
    describe('migrateDeprecatedSettings', () => {
        ...
        it('should migrate disabled extensions from user and workspace settings', () => {
            ...
            expect(mockDisableExtension).toHaveBeenCalledWith('user-ext-1', SettingScope.User, MOCK_WORKSPACE_DIR);
            expect(mockDisableExtension).toHaveBeenCalledWith('shared-ext', SettingScope.User, MOCK_WORKSPACE_DIR);
            // Check workspace settings migration
            expect(mockDisableExtension).toHaveBeenCalledWith('workspace-ext-1', SettingScope.Workspace, MOCK_WORKSPACE_DIR);
            expect(mockDisableExtension).toHaveBeenCalledWith('shared-ext', SettingScope.Workspace, MOCK_WORKSPACE_DIR);
