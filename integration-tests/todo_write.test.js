...
Use the todo_write tool to create this list.`;
        ...
        const todoWriteCalls = toolLogs.filter((t) => t.toolRequest.name === 'todo_write');
        ...
        for (const todo of todoArgs.todos) {
            ...
            expect(['pending', 'in_progress', 'completed', 'cancelled']).toContain(todo.status);
        }
...
//# sourceMappingURL=todo_write.test.js.map