...
export const getLatestGitHubRelease = async (proxy) => {
    try {
        ...
        const endpoint = `https://api.github.com/repos/leigest519/OpenGame-action/releases/latest`;
        ...
        console.debug(`Failed to determine latest qwen-code-action release:`, _error);
        throw new Error(`Unable to determine the latest qwen-code-action release on GitHub.`);
    }
};
/**
