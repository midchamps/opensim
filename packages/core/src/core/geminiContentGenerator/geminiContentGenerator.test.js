...
describe('GeminiContentGenerator', () => {
    ...
    it('should call generateContent on the underlying model', async () => {
        ...
        expect(mockGoogleGenAI.models.generateContent).toHaveBeenCalledWith(expect.objectContaining({
            ...request,
    ...
    it('should call generateContentStream on the underlying model', async () => {
        ...
        expect(mockGoogleGenAI.models.generateContentStream).toHaveBeenCalledWith(expect.objectContaining({
            ...request,
            config: expect.objectContaining({
                temperature: 1,
                topP: 0.95,
    ...
    it('should map reasoning effort to thinkingConfig', async () => {
        const generatorWithReasoning = new GeminiContentGenerator({ apiKey: 'test' }, {
...
//# sourceMappingURL=geminiContentGenerator.test.js.map