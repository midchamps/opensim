...
export function getDiagnoserConfig() {
    return {
        apiKey: env('REASONING_MODEL_API_KEY') ||
            env('DASHSCOPE_API_KEY') ||
            env('OPENAI_API_KEY'),
        baseUrl: env('REASONING_MODEL_BASE_URL') ||
            env('OPENAI_BASE_URL') ||
            'https://dashscope-intl.aliyuncs.com/compatible-mode/v1',
        modelName: env('DIAGNOSER_MODEL_NAME') ||
...
export function getGeneralizerConfig() {
    return {
        apiKey: env('REASONING_MODEL_API_KEY') ||
            env('DASHSCOPE_API_KEY') ||
            env('OPENAI_API_KEY'),
        baseUrl: env('REASONING_MODEL_BASE_URL') ||
            env('OPENAI_BASE_URL') ||
            'https://dashscope-intl.aliyuncs.com/compatible-mode/v1',
        modelName: env('GENERALIZER_MODEL_NAME') ||
            env('REASONING_MODEL_NAME') ||
            'qwen-plus',
        temperature: 0.4,
        maxTokens: 4000,
...
export function getRepairerConfig() {
    return {
        apiKey: env('REASONING_MODEL_API_KEY') ||
            env('DASHSCOPE_API_KEY') ||
            env('OPENAI_API_KEY'),
        baseUrl: env('REASONING_MODEL_BASE_URL') ||
            env('OPENAI_BASE_URL') ||
            'https://dashscope-intl.aliyuncs.com/compatible-mode/v1',
        modelName: env('REPAIRER_MODEL_NAME') ||
            env('REASONING_MODEL_NAME') ||
            'qwen-plus',
        temperature: 0.3,
        maxTokens: 4000,
