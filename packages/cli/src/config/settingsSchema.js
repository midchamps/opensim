 ...
 */
import { ApprovalMode, DEFAULT_TRUNCATE_TOOL_OUTPUT_LINES, DEFAULT_TRUNCATE_TOOL_OUTPUT_THRESHOLD, } from '@opengame/opengame-core';
/**
...
const SETTINGS_SCHEMA = {
    ...
    general: {
        ...
        properties: {
            ...
            gitCoAuthor: {
                ...
                requiresRestart: false,
                default: true,
                description: 'Automatically add a Co-authored-by trailer to git commit messages when commits are made through OpenGame.',
                showInDialog: false,
            },
            checkpointing: {
                type: 'object',
    ...
    ui: {
        ...
        properties: {
            ...
            showStatusInTitle: {
                ...
                requiresRestart: false,
                default: false,
                description: 'Show OpenGame status and thoughts in the terminal window title',
                showInDialog: true,
            },
            hideTips: {
                type: 'boolean',
            ...
            hideProviderStatus: {
                ...
                requiresRestart: false,
                default: false,
                description: 'Hide the per-modality provider status line shown below the header at startup',
                showInDialog: true,
            },
            hideBanner: {
                type: 'boolean',
            ...
            hideContextSummary: {
                ...
                requiresRestart: false,
                default: false,
                description: 'Hide the context summary (QWEN.md, MCP servers) above the input.',
                showInDialog: true,
            },
            footer: {
                type: 'object',
    ...
    openGame: {
        ...
        requiresRestart: true,
        default: {},
        description: "OpenGame's per-modality generative-AI provider configuration. " +
        ...
        properties: {
            providers: {
                ...
                default: undefined,
                description: 'Per-modality provider configuration. Environment variables ' +
