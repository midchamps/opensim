...
import { SlashCommandStatus, ToolConfirmationOutcome, makeFakeConfig, } from '@opengame/opengame-core';
...
describe('useSlashCommandProcessor', () => {
    ...
    describe('Lifecycle', () => {
        it('should abort command loading when the hook unmounts', () => {
            ...
            mockOpenAuthDialog, vi.fn(), // openEditorDialog
            mockSetQuittingMessages, vi.fn(), // openSettingsDialog
