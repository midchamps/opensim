...
d('BOM end-to-end integration', () => {
    ...
    async function runAndAssert(filename, content, expectedText) {
        ...
        if (expectedText === null) {
            expect(lower.includes('binary') ||
                lower.includes('skipped binary file') ||
                lower.includes('cannot display')).toBeTruthy();
        }
        else {
...
//# sourceMappingURL=utf-bom-encoding.test.js.map