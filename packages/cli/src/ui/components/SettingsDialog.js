...
export function SettingsDialog({ settings, onSelect, onRestartRequest, availableTerminalHeight, config, }) {
                    ...
                    if (!requiresRestart(key)) {
                        ...
                        if (key === 'tools.approvalMode' &&
                            ...
                            try {
                                ...
                                console.error('Failed to apply approval mode to current session:', error);
                            }
                        }
    ...
    return (_jsx(Box, { borderStyle: "round", borderColor: theme.border.default, flexDirection: "row", padding: 1, width: "100%", height: "100%", children: _jsxs(Box, { flexDirection: "column", flexGrow: 1, children: [_jsxs(Text, { bold: focusSection === 'settings', wrap: "truncate", children: [focusSection === 'settings' ? '> ' : '  ', t('Settings')] }), _jsx(Box, { height: 1 }), showScrollUp && _jsx(Text, { color: theme.text.secondary, children: "\u25B2" }), visibleItems.map((item, idx) => {
                ...
                }), showScrollDown && _jsx(Text, { color: theme.text.secondary, children: "\u25BC" }), _jsx(Box, { height: 1 }), showScopeSelection && (_jsx(Box, { marginTop: 1, children: _jsx(ScopeSelector, { onSelect: handleScopeSelect, onHighlight: handleScopeHighlight, isFocused: focusSection === 'scope', initialScope: selectedScope }) })), _jsx(Box, { height: 1 }), _jsx(Text, { color: theme.text.secondary, children: t('(Use Enter to select{{tabText}})', {
                        tabText: showScopeSelection ? t(', Tab to change focus') : '',
                    }) }), showRestartPrompt && (_jsx(Text, { color: theme.status.warning, children: t('To see changes, OpenGame must be restarted. Press r to exit and apply changes now.') }))] }) }));
}
