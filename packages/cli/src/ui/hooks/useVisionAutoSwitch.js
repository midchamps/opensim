...
import { isSupportedImageMimeType, getUnsupportedImageFormatWarning, } from '@opengame/opengame-core';
/**
 ...
 */
export function processVisionSwitchOutcome(outcome) {
 ...
 */
export function getVisionSwitchGuidanceMessage() {
    const vlModelId = getDefaultVisionModel();
...
//# sourceMappingURL=useVisionAutoSwitch.js.map