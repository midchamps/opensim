...
export interface ConfigParameters {
  ...
  // Per-modality provider configuration for OpenGame's reasoning / image /
  // video / audio tools. See packages/core/src/services/providerConfig.ts
...
export class Config {
  ...
  private readonly openGameProviders?: OpenGameProvidersSettings;
