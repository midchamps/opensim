...
import { OutputFormat } from '@opengame/opengame-core';
...
describe('gemini.tsx main function', () => {
    ...
    it('invokes runNonInteractiveStreamJson and performs cleanup in stream-json mode', async () => {
        ...
        vi.spyOn(extensionModule.ExtensionStorage, 'getUserExtensionsDir').mockReturnValue('/tmp/extensions');
        ...
        expect(validateAuthSpy).toHaveBeenCalledWith(undefined, undefined, configStub, expect.any(Object));
...
describe('startInteractiveUI', () => {
    ...
    it('should not check for updates when update nag is disabled', async () => {
        ...
        await startInteractiveUI(mockConfig, settingsWithUpdateNagDisabled, mockStartupWarnings, mockWorkspaceRoot, mockInitializationResult);
        await new Promise((resolve) => setTimeout(resolve, 0));
