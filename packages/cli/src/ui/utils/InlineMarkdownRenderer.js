...
const RenderInlineInternal = ({ text, textColor = theme.text.primary, }) => {
        ...
        try {
            if (fullMatch.startsWith('**') &&
                ...
                if (linkMatch) {
                    ...
                    renderedNode = (_jsxs(Text, { children: [linkText, _jsxs(Text, { color: theme.text.link, children: [" (", url, ")"] })] }, key));
                }
            }
