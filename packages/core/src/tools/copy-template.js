...
export class CopyTemplateTool extends BaseDeclarativeTool {
    ...
    static Name = 'CopyTemplate';
    constructor(config) {
        super(CopyTemplateTool.Name, 'CopyTemplate', //ToolDisplayNames.COPY_TEMPLATE,
        'Copies the pre-built game template (Phaser + Vite + TypeScript) to your working directory. Use this FIRST before writing any code - do NOT code from scratch!', Kind.Execute, {
            type: 'object',
            properties: {
                project_name: {
                    type: 'string',
