...
export class MeleeAttack extends BaseBehavior {
    ...
    onAttach() {
        ...
        this.meleeTrigger = utils.createTrigger(owner.scene, owner, 0, 0, this.range, this.width);
    }
    /**
    ...
    update() {
        ...
        utils.updateMeleeTrigger(owner, this.meleeTrigger, facingDirection, this.range, this.width);
    }
    /**
