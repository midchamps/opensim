...
export const setupCommand = {
    ...
    description: 'show which generative-AI providers (reasoning/image/video/audio) are configured',
    ...
    action: async (context) => {
        ...
        sections.push('');
        sections.push('Full reference: docs/users/configuration/api-keys.md  ·  template: .env.example');
        context.ui.addItem({
