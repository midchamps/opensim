...
import { SDKTestHelper, extractText, createSharedTestOptions, assertSuccessfulCompletion, } from './test-helper.js';
    ...
    describe('logLevel Option', () => {
        it('should respect logLevel: debug and capture detailed logs', async () => {
            ...
            try {
                ...
                const hasDebugLogs = stderrMessages.some((msg) => msg.includes('[DEBUG]') || msg.includes('debug'));
        ...
        it('should respect logLevel: info and filter out debug messages', async () => {
            ...
            try {
                ...
                const sdkDebugLogs = stderrMessages.filter((msg) => msg.includes('[DEBUG]') && msg.includes('[ProcessTransport]'));
        ...
        it('should respect logLevel: warn and only show warnings and errors', async () => {
            ...
            try {
                ...
                const sdkInfoOrDebugLogs = stderrMessages.filter((msg) => (msg.includes('[DEBUG]') || msg.includes('[INFO]')) &&
        ...
        it('should respect logLevel: error and only show error messages', async () => {
            ...
            try {
                ...
                const sdkNonErrorLogs = stderrMessages.filter((msg) => (msg.includes('[DEBUG]') ||
                    msg.includes('[INFO]') ||
                    msg.includes('[WARN]')) &&
                    (msg.includes('[ProcessTransport]') ||
                        msg.includes('[createQuery]') ||
        ...
        it.skip('should accept authType: qwen-oauth', async () => {
            ...
            try {
                ...
                if (result === 'timeout') {
                    ...
                    const hasAuthTypeArg = stderrMessages.some((msg) => msg.includes('--auth-type'));
...
//# sourceMappingURL=configuration-options.test.js.map