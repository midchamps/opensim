 ...
 */
import { OutputFormat, JsonFormatter, parseAndFormatApiError, FatalTurnLimitedError, FatalCancellationError, ToolErrorType, } from '@opengame/opengame-core';
...
export function handleToolError(toolName, toolError, config, errorCode, resultDisplay) {
    ...
    if (config.getDebugMode()) {
        console.error(`Error executing tool ${toolName}: ${resultDisplay || toolError.message}`);
    }
}
/**
