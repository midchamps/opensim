...
import { FileSearchFactory } from '@opengame/opengame-core';
import { createTmpDir, cleanupTmpDir } from '@opengame/opengame-test-utils';
    ...
    describe('UI State and Loading Behavior', () => {
        ...
        it('should show a loading indicator and clear old suggestions for subsequent searches that take longer than 200ms', async () => {
            ...
            const mockFileSearch = {
                ...
                search: vi
                    .fn()
                    .mockImplementation(async (...args) => realFileSearch.search(...args)),
            };
