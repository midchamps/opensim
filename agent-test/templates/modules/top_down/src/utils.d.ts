 ...
 */
export declare function angleToDirection(angle: number): 'left' | 'right' | 'up' | 'down';
/**
 ...
 */
export declare function directionToAngle(direction: 'left' | 'right' | 'up' | 'down'): number;
 ...
 */
export declare function createProjectileAtAngle(scene: Phaser.Scene, x: number, y: number, textureKey: string, angle: number, speed: number, targetSize?: number, damage?: number): Phaser.Physics.Arcade.Sprite;
/**
