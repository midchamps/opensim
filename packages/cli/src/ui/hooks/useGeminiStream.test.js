...
import { ApprovalMode, AuthType, GeminiEventType as ServerGeminiEventType, ToolErrorType, ToolConfirmationOutcome, } from '@opengame/opengame-core';
...
describe('useGeminiStream', () => {
    ...
    const renderTestHook = (initialToolCalls = [], geminiClient) => {
        ...
        const { result, rerender } = renderHook((props) => {
            ...
            return useGeminiStream(props.client, props.history, props.addItem, props.config, props.loadedSettings, props.onDebugMessage, props.handleSlashCommand, props.shellModeActive, () => 'vscode', () => { }, () => Promise.resolve(), false, () => { }, () => { }, () => { }, false, // visionModelPreviewEnabled
            () => { }, 80, 24);
        }, {
            initialProps: {
                client,
    ...
    it('should submit tool responses when all tool calls are completed and ready', async () => {
        ...
        renderHook(() => useGeminiStream(new MockedGeminiClientClass(mockConfig), [], mockAddItem, mockConfig, mockLoadedSettings, mockOnDebugMessage, mockHandleSlashCommand, false, () => 'vscode', () => { }, () => Promise.resolve(), false, () => { }, () => { }, () => { }, false, // visionModelPreviewEnabled
        () => { }, 80, 24));
        ...
        expect(mockSendMessageStream).toHaveBeenCalledWith(expectedMergedResponse, expect.any(AbortSignal), 'prompt-id-2', { isContinuation: true });
    });
    it('should handle all tool calls being cancelled', async () => {
        ...
        renderHook(() => useGeminiStream(client, [], mockAddItem, mockConfig, mockLoadedSettings, mockOnDebugMessage, mockHandleSlashCommand, false, () => 'vscode', () => { }, () => Promise.resolve(), false, () => { }, () => { }, () => { }, false, // visionModelPreviewEnabled
        () => { }, 80, 24));
    ...
    it('should not flicker streaming state to Idle between tool completion and submission', async () => {
        ...
        const { result, rerender } = renderHook(() => useGeminiStream(new MockedGeminiClientClass(mockConfig), [], mockAddItem, mockConfig, mockLoadedSettings, mockOnDebugMessage, mockHandleSlashCommand, false, () => 'vscode', () => { }, () => Promise.resolve(), false, () => { }, () => { }, () => { }, false, // visionModelPreviewEnabled
        () => { }, 80, 24));
        ...
        await waitFor(() => {
            expect(mockSendMessageStream).toHaveBeenCalledWith(toolCallResponseParts, expect.any(AbortSignal), 'prompt-id-4', { isContinuation: true });
        });
    ...
    describe('User Cancellation', () => {
        ...
        it('should call onCancelSubmit handler when escape is pressed', async () => {
            ...
            mockSendMessageStream.mockReturnValue(mockStream);
            const { result } = renderHook(() => useGeminiStream(mockConfig.getGeminiClient(), [], mockAddItem, mockConfig, mockLoadedSettings, mockOnDebugMessage, mockHandleSlashCommand, false, () => 'vscode', () => { }, () => Promise.resolve(), false, () => { }, () => { }, cancelSubmitSpy, false, // visionModelPreviewEnabled
            () => { }, 80, 24));
            // Start a query
            await act(async () => {
                result.current.submitQuery('test query');
        ...
        it('should call setShellInputFocused(false) when escape is pressed', async () => {
            ...
            mockSendMessageStream.mockReturnValue(mockStream);
            const { result } = renderHook(() => useGeminiStream(mockConfig.getGeminiClient(), [], mockAddItem, mockConfig, mockLoadedSettings, mockOnDebugMessage, mockHandleSlashCommand, false, () => 'vscode', () => { }, () => Promise.resolve(), false, () => { }, () => { }, vi.fn(), false, setShellInputFocusedSpy, // Pass the spy here
            80, 24));
            // Start a query
            await act(async () => {
                result.current.submitQuery('test query');
    ...
    describe('Slash Command Handling', () => {
        ...
        it('should call Gemini with prompt content when slash command returns a `submit_prompt` action', async () => {
            ...
            await waitFor(() => {
                ...
                expect(localMockSendMessageStream).toHaveBeenCalledWith('This is the actual prompt from the command file.', expect.any(AbortSignal), expect.any(String), undefined);
                expect(mockScheduleToolCalls).not.toHaveBeenCalled();
            });
        });
        it('should correctly handle a submit_prompt action with empty content', async () => {
            ...
            await waitFor(() => {
                ...
                expect(localMockSendMessageStream).toHaveBeenCalledWith('', expect.any(AbortSignal), expect.any(String), undefined);
            });
        });
    ...
    describe('Memory Refresh on save_memory', () => {
        it('should call performMemoryRefresh when a save_memory tool call completes successfully', async () => {
            ...
            renderHook(() => useGeminiStream(new MockedGeminiClientClass(mockConfig), [], mockAddItem, mockConfig, mockLoadedSettings, mockOnDebugMessage, mockHandleSlashCommand, false, () => 'vscode', () => { }, mockPerformMemoryRefresh, false, () => { }, () => { }, () => { }, false, // visionModelPreviewEnabled
            () => { }, 80, 24));
    ...
    describe('Error Handling', () => {
        it('should call parseAndFormatApiError with the correct authType on stream initialization failure', async () => {
            ...
            const { result } = renderHook(() => useGeminiStream(new MockedGeminiClientClass(testConfig), [], mockAddItem, testConfig, mockLoadedSettings, mockOnDebugMessage, mockHandleSlashCommand, false, () => 'vscode', () => { }, () => Promise.resolve(), false, () => { }, () => { }, () => { }, false, // visionModelPreviewEnabled
            () => { }, 80, 24));
            // 2. Action
            await act(async () => {
    ...
    describe('handleFinishedEvent', () => {
        it('should add info message for MAX_TOKENS finish reason', async () => {
            ...
            const { result } = renderHook(() => useGeminiStream(new MockedGeminiClientClass(mockConfig), [], mockAddItem, mockConfig, mockLoadedSettings, mockOnDebugMessage, mockHandleSlashCommand, false, () => 'vscode', () => { }, () => Promise.resolve(), false, () => { }, () => { }, () => { }, false, // visionModelPreviewEnabled
            () => { }, 80, 24));
            // Submit a query
            await act(async () => {
    ...
    describe('Thought Reset', () => {
        ...
        it('should memoize pendingHistoryItems', () => {
            ...
            const { result, rerender } = renderHook(() => useGeminiStream(mockConfig.getGeminiClient(), [], mockAddItem, mockConfig, mockLoadedSettings, mockOnDebugMessage, mockHandleSlashCommand, false, () => 'vscode', () => { }, () => Promise.resolve(), false, () => { }, () => { }, () => { }, false, // visionModelPreviewEnabled
            vi.fn(), // setShellInputFocused
            80, 24));
        ...
        it('should reset thought to null when there is an error', async () => {
            ...
            expect(mockParseAndFormatApiError).toHaveBeenCalledWith({ message: 'Test error' }, expect.any(String));
        });
    });
    describe('Concurrent Execution Prevention', () => {
        it('should prevent concurrent submitQuery calls', async () => {
            ...
            expect(mockSendMessageStream).toHaveBeenCalledTimes(1);
            expect(mockSendMessageStream).toHaveBeenCalledWith('First query', expect.any(AbortSignal), expect.any(String), undefined);
        ...
        it('should allow subsequent calls after first call completes', async () => {
            ...
            expect(mockSendMessageStream).toHaveBeenNthCalledWith(1, 'First query', expect.any(AbortSignal), expect.any(String), undefined);
        ...
        it('should reset execution flag even when query preparation fails', async () => {
            ...
            expect(mockSendMessageStream).toHaveBeenCalledTimes(1);
            expect(mockSendMessageStream).toHaveBeenCalledWith('Second query', expect.any(AbortSignal), expect.any(String), undefined);
        });
    });
