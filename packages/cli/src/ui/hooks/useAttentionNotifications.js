...
import { notifyTerminalAttention, AttentionNotificationReason, } from '../../utils/attentionNotification.js';
export const LONG_TASK_NOTIFICATION_THRESHOLD_SECONDS = 20;
export const useAttentionNotifications = ({ isFocused, streamingState, elapsedTime, settings, }) => {
