 ...
 */
import type { MCPServerConfig, BugCommandSettings, TelemetrySettings, AuthType, ChatCompressionSettings } from '@opengame/opengame-core';
...
declare const SETTINGS_SCHEMA: {
    ...
    readonly general: {
        ...
        readonly properties: {
            ...
            readonly gitCoAuthor: {
                ...
                readonly description: "Automatically add a Co-authored-by trailer to git commit messages when commits are made through OpenGame.";
                readonly showInDialog: false;
            };
    ...
    readonly ui: {
        ...
        readonly properties: {
            ...
            readonly showStatusInTitle: {
                ...
                readonly requiresRestart: false;
                readonly default: false;
                readonly description: "Show OpenGame status and thoughts in the terminal window title";
                readonly showInDialog: true;
            };
            readonly hideTips: {
                readonly type: "boolean";
            ...
            readonly hideProviderStatus: {
                readonly type: "boolean";
                readonly label: "Hide Provider Status Banner";
                readonly category: "UI";
                readonly requiresRestart: false;
                readonly default: false;
                readonly description: "Hide the per-modality provider status line shown below the header at startup";
                readonly showInDialog: true;
            };
            readonly hideBanner: {
                readonly type: "boolean";
            ...
            readonly hideContextSummary: {
                ...
                readonly requiresRestart: false;
                readonly default: false;
                readonly description: "Hide the context summary (QWEN.md, MCP servers) above the input.";
                readonly showInDialog: true;
            };
            readonly footer: {
                readonly type: "object";
    ...
    readonly openGame: {
        readonly type: "object";
        readonly label: "OpenGame Providers";
        readonly category: "Advanced";
        readonly requiresRestart: true;
        readonly default: {};
        readonly description: string;
