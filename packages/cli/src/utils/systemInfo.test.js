...
import { IdeClient } from '@opengame/opengame-core';
...
describe('systemInfo', () => {
    ...
    beforeEach(() => {
        ...
        vi.mocked(child_process.execSync).mockImplementation((command, options) => {
            if (options &&
    ...
    describe('getExtendedSystemInfo', () => {
        it('should include memory usage and base URL', async () => {
            ...
            const { AuthType } = await import('@opengame/opengame-core');
