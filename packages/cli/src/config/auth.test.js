...
describe('validateAuthMethod', () => {
    ...
    it('should return an error message for USE_OPENAI if OPENAI_API_KEY is not set', () => {
        ...
        expect(validateAuthMethod(AuthType.USE_OPENAI)).toBe('OPENAI_API_KEY environment variable not found. You can enter it interactively or add it to your .env file.');
    });
