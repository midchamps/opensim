...
import { EXTENSIONS_CONFIG_FILENAME, ExtensionStorage, INSTALL_METADATA_FILENAME, annotateActiveExtensions, loadExtension, } from '../extension.js';
...
describe('update tests', () => {
    ...
    describe('updateExtension', () => {
        it('should update a git-installed extension', async () => {
            ...
            ], process.cwd(), new ExtensionEnablementManager(ExtensionStorage.getUserExtensionsDir()))[0];
            const updateInfo = await updateExtension(extension, tempHomeDir, async (_) => true, ExtensionUpdateState.UPDATE_AVAILABLE, () => { });
        ...
        it('should call setExtensionUpdateState with UPDATING and then UPDATED_NEEDS_RESTART on success', async () => {
            ...
            await updateExtension(extension, tempHomeDir, async (_) => true, ExtensionUpdateState.UPDATE_AVAILABLE, dispatch);
        ...
        it('should call setExtensionUpdateState with ERROR on failure', async () => {
            ...
            await expect(updateExtension(extension, tempHomeDir, async (_) => true, ExtensionUpdateState.UPDATE_AVAILABLE, dispatch)).rejects.toThrow();
            expect(dispatch).toHaveBeenCalledWith({
                type: 'SET_STATE',
                payload: {
                    name: extensionName,
