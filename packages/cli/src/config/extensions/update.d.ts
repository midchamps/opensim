...
import type { GeminiCLIExtension } from '@opengame/opengame-core';
...
export declare function checkForAllExtensionUpdates(extensions: GeminiCLIExtension[], dispatch: (action: ExtensionUpdateAction) => void): Promise<void>;
