...
describe('SessionPicker', () => {
    ...
    describe('Keyboard Navigation', () => {
        ...
        it('should navigate with vim keys (j/k)', async () => {
            ...
            const onSelect = vi.fn();
            const onCancel = vi.fn();
            const { stdin, unmount } = render(_jsx(KeypressProvider, { kittyProtocolEnabled: false, children: _jsx(SessionPicker, { sessionService: mockService, onSelect: onSelect, onCancel: onCancel }) }));
            await wait(100);
