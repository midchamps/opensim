...
async function main() {
    ...
    if (args.length === 0) {
        console.error('Usage: npx tsx scripts/evolve.ts <project-dir> [<project-dir2> ...]');
        console.error('\nExamples:');
        console.error('  npx tsx scripts/evolve.ts ../output/v-2026-03-06T12-00-00/');
        console.error('  npx tsx scripts/evolve.ts ../output/v-proj1/ ../output/v-proj2/');
        process.exit(1);
    }
