...
// eslint-disable-next-line vitest/no-mocks-import -- legacy explicit mock control wired via __mocks__
...
describe('ReadManyFilesTool', () => {
    ...
    describe('execute', () => {
        ...
        it('should add a warning for truncated files', async () => {
            ...
            expect(truncatedFileContent).toContain('Showing lines 1-250 of 2500 total lines.');
        });
