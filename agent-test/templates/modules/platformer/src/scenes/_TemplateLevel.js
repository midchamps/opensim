...
export class _TemplateLevel extends BaseLevelScene {
    ...
    createBackground() {
        ...
        this.background = this.add.tileSprite(0, 0, this.mapWidth, this.mapHeight, 'level1_background');
    ...
    createTileMap() {
        ...
        this.groundTileset = this.map.addTilesetImage('tileset_name_in_tiled', // TODO: Replace - must match JSON exactly
        'tileset_texture_key');
        // 3. Create layer
