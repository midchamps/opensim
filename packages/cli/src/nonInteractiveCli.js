...
import { executeToolCall, shutdownTelemetry, isTelemetrySdkInitialized, GeminiEventType, FatalInputError, promptIdContext, OutputFormat, InputFormat, uiTelemetryService, parseAndFormatApiError, } from '@opengame/opengame-core';
            ...
            while (true) {
                ...
                if (toolCallRequests.length > 0) {
                    ...
                    for (const requestInfo of toolCallRequests) {
                        ...
                        const nonTaskOutputHandler = !isTaskTool && !adapter
                            ? (callId, outputChunk) => {
                        ...
                        const toolResponse = await executeToolCall(config, finalRequestInfo, abortController.signal, outputUpdateHandler || toolCallUpdateCallback
                            ? {
