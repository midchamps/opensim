...
vi.mock('../../utils/schemaConverter.js', () => ({
    convertSchema: vi.fn((schema) => schema),
}));
...
describe('AnthropicContentConverter', () => {
    ...
    describe('mapAnthropicFinishReasonToGemini', () => {
        it('maps known reasons', () => {
            expect(converter.mapAnthropicFinishReasonToGemini('end_turn')).toBe(FinishReason.STOP);
            expect(converter.mapAnthropicFinishReasonToGemini('max_tokens')).toBe(FinishReason.MAX_TOKENS);
            expect(converter.mapAnthropicFinishReasonToGemini('content_filter')).toBe(FinishReason.SAFETY);
        });
