...
export class CharacterSelectScene extends Phaser.Scene {
    ...
    createCharacterDisplay() {
        ...
        this.characters.forEach((character, index) => {
            ...
            frame.strokeRoundedRect(x - frameWidth / 2, characterY - frameHeight / 2, frameWidth, frameHeight, 10);
    ...
    createControlHints() {
        ...
        this.controlsText = this.add
            .text(width / 2, height - 80, 'A/D or Arrow Keys: Select    ENTER/SPACE: Confirm', {
            fontFamily: 'monospace',
            fontSize: '18px',
            color: '#ffffff',
            stroke: '#000000',
    ...
    updateSelection() {
        ...
        this.characters.forEach((_, index) => {
            ...
            if (isSelected) {
                ...
                const baseScale = Math.min(200 / this.characterSprites[index].width, 280 / this.characterSprites[index].height);
