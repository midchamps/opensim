...
const MarkdownDisplayInternal = ({ text, isPending, availableTerminalHeight, terminalWidth, textColor = theme.text.primary, }) => {
    if (!text)
    ...
    lines.forEach((line, index) => {
        ...
        if (codeFenceMatch) {
            ...
            if (index + 1 < lines.length &&
                ...
                addContentBlock(_jsx(Box, { children: _jsx(Text, { wrap: "wrap", children: _jsx(RenderInline, { text: line, textColor: textColor }) }) }, key));
            }
        }
            ...
            switch (level) {
                case 1:
                    headerNode = (_jsx(Text, { bold: true, color: textColor, children: _jsx(RenderInline, { text: headerText, textColor: textColor }) }));
                    break;
                case 2:
                    headerNode = (_jsx(Text, { bold: true, color: textColor, children: _jsx(RenderInline, { text: headerText, textColor: textColor }) }));
                    break;
                case 3:
                    ...
                    break;
                case 4:
                    headerNode = (_jsx(Text, { italic: true, color: textColor, children: _jsx(RenderInline, { text: headerText, textColor: textColor }) }));
                    break;
                default:
                    headerNode = (_jsx(Text, { color: textColor, children: _jsx(RenderInline, { text: headerText, textColor: textColor }) }));
                    break;
            }
            if (headerNode)
            ...
            addContentBlock(_jsx(RenderListItem, { itemText: itemText, type: "ul", marker: marker, leadingWhitespace: leadingWhitespace, textColor: textColor }, key));
        }
        else if (olMatch) {
            const leadingWhitespace = olMatch[1];
            const marker = olMatch[2];
            const itemText = olMatch[3];
            addContentBlock(_jsx(RenderListItem, { itemText: itemText, type: "ol", marker: marker, leadingWhitespace: leadingWhitespace, textColor: textColor }, key));
        }
        else {
            if (line.trim().length === 0 && !inCodeBlock) {
                ...
                addContentBlock(_jsx(Box, { children: _jsx(Text, { wrap: "wrap", color: textColor, children: _jsx(RenderInline, { text: line, textColor: textColor }) }) }, key));
            }
        }
    });
    if (inCodeBlock) {
