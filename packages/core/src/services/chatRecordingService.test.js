...
describe('ChatRecordingService', () => {
    ...
    beforeEach(() => {
        ...
        vi.mocked(randomUUID).mockImplementation(() => `00000000-0000-0000-0000-00000000000${++uuidCounter}`);
    ...
    describe('recordUserMessage', () => {
        it('should record a user message immediately', () => {
            const userParts = [{ text: 'Hello, world!' }];
        ...
        it('should chain messages correctly with parentUuid', () => {
            ...
            const user1 = calls[0][1];
            const assistant = calls[1][1];
            const user2 = calls[2][1];
