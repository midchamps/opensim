...
import { checkForExtensionUpdate, cloneFromGit, extractFile, findReleaseAsset, parseGitHubRepoForReleases, } from './github.js';
...
describe('git extension helpers', () => {
    ...
    describe('parseGitHubRepoForReleases', () => {
        ...
        it('should fail on a non-GitHub URL', () => {
            ...
            expect(() => parseGitHubRepoForReleases(source)).toThrow('Invalid GitHub repository source: https://example.com/owner/repo.git. Expected "owner/repo" or a github repo uri.');
        });
