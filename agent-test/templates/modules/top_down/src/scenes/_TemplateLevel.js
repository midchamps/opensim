...
export class _TemplateLevel extends BaseLevelScene {
    ...
    createEnvironment() {
        ...
        this.floorTileset = floorMap.addTilesetImage('theme_floor', // TODO: = tileset_key (tileset name inside JSON)
        'theme_floor');
        ...
        this.wallsTileset = wallsMap.addTilesetImage('theme_walls', // TODO: = tileset_key (tileset name inside JSON)
        'theme_walls');
    ...
    createEntities() {
        ...
        const objectLayer = this.map.getObjectLayer('Objects');
        if (objectLayer) {
            const playerSpawn = objectLayer.objects.find((obj) => obj.type === 'player_spawn');
            if (playerSpawn) {
        ...
        this.player.getHealthPercentage = () => (this.player.health / this.player.maxHealth) * 100;
...
//# sourceMappingURL=_TemplateLevel.js.map