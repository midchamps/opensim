...
describe('modelCommand', () => {
    let mockContext;
    const mockGetAvailableModelsForAuthType = vi.mocked(availableModelsModule.getAvailableModelsForAuthType);
    beforeEach(() => {
    ...
    it('should return error for unsupported auth types', async () => {
        ...
        expect(result).toEqual({
            type: 'message',
            messageType: 'error',
            content: 'No models available for the current authentication type (UNSUPPORTED_AUTH_TYPE).',
        });
    });
