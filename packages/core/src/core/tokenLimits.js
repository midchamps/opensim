export const DEFAULT_TOKEN_LIMIT = 131_072; // 128K (power-of-two)
export const DEFAULT_OUTPUT_TOKEN_LIMIT = 4_096; // 4K tokens
/**
...
const PATTERNS = [
    ...
    [/^glm-4\.5(?:-.*)?$/, LIMITS['128k']],
    [/^glm-4\.6(?:-.*)?$/, 202_752], // exact limit from the model config file
    // -------------------
    // DeepSeek
    // -------------------
