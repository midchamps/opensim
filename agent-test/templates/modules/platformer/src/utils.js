 ...
 */
export function createBullet(scene, x, y, textureKey, velocityX, velocityY = 0, damage) {
    const bullet = createProjectile(scene, x, y, textureKey, PROJECTILE_SIZES.BULLET_SMALL, false, damage);
