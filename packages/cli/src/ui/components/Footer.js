...
import { shortenPath, tildeifyPath } from '@opengame/opengame-core';
...
export const Footer = () => {
    ...
    const { model, targetDir, debugMode, branchName, debugMessage, errorCount, showErrorDetails, promptTokenCount, nightly, isTrustedFolder, } = {
    ...
    return (_jsxs(Box, { justifyContent: justifyContent, width: "100%", flexDirection: "row", alignItems: "center", children: [(debugMode || displayVimMode || !hideCWD) && (_jsxs(Box, { children: [debugMode && _jsx(DebugProfiler, {}), displayVimMode && (_jsxs(Text, { color: theme.text.secondary, children: ["[", displayVimMode, "] "] })), !hideCWD &&
