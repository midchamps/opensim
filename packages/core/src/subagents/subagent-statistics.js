...
export class SubagentStatistics {
    ...
    getSummary(now = Date.now()) {
        ...
        const successRate = totalToolCalls > 0
            ...
            : 0;
        const totalTokens = this.inputTokens +
            this.outputTokens +
            this.thoughtTokens +
            this.cachedTokens;
    ...
    formatDetailed(taskDesc, now = Date.now()) {
        ...
        lines.push(`⏱️ Duration: ${this.fmtDuration(stats.totalDurationMs)} | 🔁 Rounds: ${stats.rounds}`);
        // Quality indicator
...
//# sourceMappingURL=subagent-statistics.js.map