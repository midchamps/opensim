...
export class QuizModal extends ModalOverlay {
    ...
    showExplanation(question, wasCorrect) {
    ...
    createQuestionUI(question) {
        ...
        question.options.forEach((option, index) => {
            ...
            const btn = this.createAnswerButton(option, index, y, btnWidth, btnHeight);
            this.answerButtons.push(btn);
            this.content.add(btn);
        });
    }
    createAnswerButton(text, index, y, width, height) {
    ...
    onAnswerSelected(index, clickedBg) {
...
//# sourceMappingURL=QuizModal.js.map